...
**Remno ApproveBot** — это легковесный, быстрый и надежный Telegram-бот, разработанный для автоматического одобрения (или отклонения) входящих заявок на вступление в закрытые каналы и группы. Идеальное решение для администраторов сообществ, позволяющее автоматизировать рутину и мгновенно принимать пользователей.

---

## ✨ Особенности

* ⚡ **Мгновенный отклики:** Автоматическое одобрение (`chat_join_request`) пользователей сразу после отправки заявки.
* 🔒 **Безопасность данных:** Конфиденциальная настройка через переменные окружения (`.env`).
* ⚙️ **Гибкая кастомизация:** Возможность отправки приветственного сообщения пользователю в ЛС после одобрения (опционально).
